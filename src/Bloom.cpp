...
Bloom::Bloom() {
	...
	this->downsampleShader = new ComputeShaderProgram(ResourceDatabase::Global->Get<ComputeShader>("./res/shaders/bloom/bloom_downsample.comp"));
	this->upsampleShader = new ComputeShaderProgram(ResourceDatabase::Global->Get<ComputeShader>("./res/shaders/bloom/bloom_upsample.comp"));
	this->finalShader = new ComputeShaderProgram(ResourceDatabase::Global->Get<ComputeShader>("./res/shaders/bloom/bloom_final.comp"));
}
