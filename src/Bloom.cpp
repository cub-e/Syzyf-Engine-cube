...
Bloom::Bloom() {
	...
	this->downsampleShader = new ComputeShaderProgram(Resources::Global->Get<ComputeShader>("./res/shaders/bloom/bloom_downsample.comp"));
	this->upsampleShader = new ComputeShaderProgram(Resources::Global->Get<ComputeShader>("./res/shaders/bloom/bloom_upsample.comp"));
	this->finalShader = new ComputeShaderProgram(Resources::Global->Get<ComputeShader>("./res/shaders/bloom/bloom_final.comp"));
}
